...
use_big_surface = False  # draw into large buffer and save hero file
...
class FontViewer:
    ...
    def render_surface(self):
        ...
        into. This is necessary to save the display to a hero file and may
    ...
    def save_png(self, name="font_viewer.hero"):
