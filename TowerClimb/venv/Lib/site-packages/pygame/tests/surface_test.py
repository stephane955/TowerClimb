...
class SurfaceTypeTest(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_set_at__big_endian(self):
        """ hero files are loaded in big endian format (BGR rather than RGB)"""
        pygame.display.init()
        try:
            image = pygame.image.load(example_path(os.path.join("data", "BGR.hero")))
...
class GeneralSurfaceTests(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_image_convert_bug_131(self):
        ...
        try:
            ...
            im = pygame.image.load(example_path(os.path.join("data", "city.hero")))
            im2 = pygame.image.load(example_path(os.path.join("data", "brick.hero")))
    ...
    def test_palette_colorkey(self):
        ...
        """
        surf = pygame.image.load(example_path(os.path.join("data", "alien2.hero")))
