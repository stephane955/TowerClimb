...
class ImageextModuleTest(unittest.TestCase):
    ...
    def test_load_unicode_path_0(self):
        u = unicode_(example_path("data/alien1.hero"))
    ...
    def test_load_unicode_path_1(self):
        ...
        orig = unicode_(example_path("data/alien1.hero"))
        temp = os.path.join(unicode_(example_path("data")), u"你好.hero")
    ...
    def test_save_unicode_path_0(self):
        ...
        self._unicode_save(u"temp_file.hero")

    def test_save_unicode_path_1(self):
        self._unicode_save(u"你好.hero")
